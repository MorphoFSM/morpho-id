...
Route::middleware(['auth:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/role-requests/{id}/approve-pending', [\App\Http\Controllers\Admin\RoleRequestController::class, 'approvePendingAdmin'])->name('role_requests.approve_pending');
    Route::post('/role-requests/{id}/reject-pending', [\App\Http\Controllers\Admin\RoleRequestController::class, 'rejectPendingAdmin'])->name('role_requests.reject_pending');
